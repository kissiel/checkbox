...
class ParametricSection(Section):
    ...
    This is similar to ``Section``, but instead looks for an arbitrary number
    of sections beginning with ``name`` and a colon (':'). E.g.:
    [foo:bar]
        somevar = someval
    [foo:baz]
        othervar = otherval
...
class Config(metaclass=ConfigMeta):
    ...
    def get_parser_obj(self):
        ...
        # TODO: write parametric section lists
        return parser
